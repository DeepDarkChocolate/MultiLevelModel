...
#@time Threads.@threads for simnum in 1:B
  ...
  @. pi2mat_sampled_tmp[x_sampled[i] .> 0.0, x_sampled[i] .> 0.0] = pi2mat_sampled_tmp1

  pi2mat_sampled_tmp2 = ones(m2,m2) .* m2 * (m2 - 1) / M2[i] / (M2[i] - 1)
  pi2mat_sampled_tmp2[diagind(pi2mat_sampled_tmp2)] .= m2 / M2[i]
  @. pi2mat_sampled_tmp[x_sampled[i] .<= 0.0, x_sampled[i] .<= 0.0] = pi2mat_sampled_tmp2

  @. pi2mat_sampled_tmp[x_sampled[i] .> 0.0, x_sampled[i] .<= 0.0] = m1 * m2 / M1[i] / M2[i]
  @. pi2mat_sampled_tmp[x_sampled[i] .<= 0.0, x_sampled[i] .> 0.0] = m1 * m2 / M1[i] / M2[i]
  pi2mat_sampled_tmp
  end for i in 1:n]
