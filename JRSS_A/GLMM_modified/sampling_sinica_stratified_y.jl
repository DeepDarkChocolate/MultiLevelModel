...
#@time Threads.@threads for simnum in 1:B
  ...
  ## normal approximation using profile likelihood
    ...
    while true
      ...
      #resTMP = updatebetamat_S(x_sampled, y_sampled, w1_sampled, w2_sampled, beta_t1, mua_t1, sigma2a_t1) # Julia Integral and findroot ftn
